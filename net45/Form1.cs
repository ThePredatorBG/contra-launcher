...
namespace Contra
{
    public partial class Form1 : Form
    {
        ...
        private void RadioFlag_GB_CheckedChanged(object sender, EventArgs e)
        {
            ...
            string motd = (new WebClient { Encoding = Encoding.UTF8 }).DownloadString("https://raw.githubusercontent.com/ThePredatorBG/contra-launcher/netcore/Versions.txt");
            string launcher_url = "https://github.com/ThePredatorBG/contra-launcher/releases/download/";
            GetLauncherUpdate(motd, launcher_url);
